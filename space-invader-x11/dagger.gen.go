...
import (
	...
	"space-invader/internal/querybuilder"
)
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "SpaceInvader":
		switch fnName {
		case "RunSpaceInvader":
			var err error
			var parent SpaceInvader
			...
			return (*SpaceInvader).RunSpaceInvader(&parent, ctx, stringArg)
		default:
	...
	case "":
		return dag.CurrentModule().
			WithObject(
				dag.TypeDef().WithObject("SpaceInvader").
					WithFunction(
						dag.NewFunction("RunSpaceInvader",
							dag.TypeDef().WithObject("Container")).
							WithArg("stringArg", dag.TypeDef().WithKind(Stringkind)))), nil
	default:
