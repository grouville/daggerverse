...
func (r *Zip) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Zip":
		...
		case "ContainerEcho":
			...
			return (*Zip).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Zip
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Zip).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
